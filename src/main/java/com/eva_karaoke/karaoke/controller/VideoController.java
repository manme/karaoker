...
import com.eva_karaoke.karaoke.service.VideoCreationService;
...
public class VideoController {
  ...
  public ResponseEntity<Video> createVideo(@RequestBody Video video) {
    Video savedVideo = videoCreationService.createAndProcessVideo(video);
  ...
  public ResponseEntity<Video> restartVideoProcessing(@PathVariable Long id,
